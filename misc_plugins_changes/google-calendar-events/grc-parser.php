...
class GCE_Parser {
	...
	function get_list( $grouped = false ) {
		...
		if( empty( $event_days) )// CUSTOM ERROR MESSAGE FOR NO EVENTS
			return '<p>' . __( 'No events? Looks like old Petey boy forgot to update the calendar. Go <a href="/contact">yell at him</a>, will ya?', GCE_TEXT_DOMAIN ) . '</p>';
